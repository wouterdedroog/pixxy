# This code has been taken from https://github.com/jamesw343/PixMob_IR/blob/master/pixmob_ir_protocol.py, but modified
# to no longer use enums for compatibility with MicroPython.
...
class CommandSingleColorExt(Command):
    ...
    _fields = {
        ...
        'red':              _Field([_FieldFragment(byte=4, offset=0, width=6, src_offset=2)], int),
        'blue':             _Field([_FieldFragment(byte=5, offset=0, width=6, src_offset=2)], int),
        'chance':           _Field([_FieldFragment(byte=6, offset=0, width=3)], int, default=Chance.CHANCE_100_PCT),
        'attack':           _Field([_FieldFragment(byte=6, offset=3, width=3)], int, default=Time.TIME_480_MS),
        'sustain':          _Field([_FieldFragment(byte=7, offset=0, width=3)], int, default=Time.TIME_480_MS),
        'release':          _Field([_FieldFragment(byte=7, offset=3, width=3)], int, default=Time.TIME_480_MS),
...
class CommandSetConfig(Command):
    ...
    _fields = {
        ...
        'attack':           _Field([_FieldFragment(byte=4, offset=3, width=3)], int, default=Time.TIME_480_MS),
        'sustain':          _Field([_FieldFragment(byte=5, offset=0, width=3)], int, default=Time.TIME_480_MS),
        'release':          _Field([_FieldFragment(byte=5, offset=3, width=3)], int, default=Time.TIME_480_MS),
    }
...
class CommandSetGlobalSustainTime(Command):
    ...
    _fields = {
        'on_start':         _Field([_FieldFragment(byte=2, offset=0, width=1)], bool, default=True, read_only=True),
        'gst_enable':       _Field([_FieldFragment(byte=2, offset=4, width=1)], bool, default=False),
        'global_sustain':   _Field([_FieldFragment(byte=4, offset=0, width=3)], int),
        'group_id':         _Field([_FieldFragment(byte=8, offset=0, width=5)], int, default=0),
    }


class CommandIdentFWVersion(Command):
    _num_bytes  = 9
    _flags_type = 0b111
    _action_id  = 12
    _fields = {
        ...
        'firmware_version': _Field([_FieldFragment(byte=6, offset=0, width=6)], int),
    }
